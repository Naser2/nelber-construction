    ...
    return (
      <section className="w-full bg-seconday-background text-white ">
        <div className="mx-auto flex flex-col md:flex-row">
          ...
          {/* Right: Text Section */}
          <div className="md:w-1/2 overflow-hidden my-8 flex flex-col justify-center items-center">
            <div className="flex flex-col justify-center px-6 md:px-0 md:w-5/6 lg:w-2/3">
