          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 ">
            ...
            <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg text-left sm:max-w-[25rem]">
              ...
              <form className="mt-6 space-y-4">
                <div className="grid grid-cols-1 max-w-[26rem]  md:grid-cols-2 gap-4">
                  <input
                    type="text"
                    placeholder="Name"
                    className="w-full max-w-[16rem] sm:max-w-[10rem]  px-4 py-3 bg-gray-100 text-gray-900 rounded-md focus:outline-none"
                  />
                  <input
                    type="email"
                    placeholder="Email"
                ...
                <div className="grid max-w-[25.6rem]  grid-cols-1 md:grid-cols-2 gap-4">
                  <input
                    type="text"
                    placeholder="Phone"
                    className="w-full  max-w-[16rem] sm:max-w-[10rem]   px-4 py-3 bg-gray-100 text-gray-900 rounded-md focus:outline-none"
                  />
                  <select className="w-ful max-w-[16rem] sm:max-w-[10rem] px-4 py-3 bg-gray-100 text-gray-900 rounded-md focus:outline-none">
                ...
                <textarea
                  ...
                  className="w-full  max-w-[16rem] sm:max-w-[23rem] px-4 py-3 bg-gray-100 text-gray-900 rounded-md focus:outline-none h-24"
                ></textarea>
            ...
            {/* Contact Info */}
            <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg text-left">
              <h3 className="text-green-400 text-lg font-semibold">
                Contact Info
              </h3>
